...
@section('content')
  <div class="container" style="margin:40px;">
    ...
    <div>
      <a href="/huis/create" class="btn btn-primary mb-3">Voeg Woning toe</a>
    </div> 
    <table class="table">
      ...
      <tbody>
          ...
          <tr>
              ...
              <td><a href="/huis/edit/{{ $huis->id }}" class="btn btn-success">Updaten</a></td>
              <td>
              ...
              <td>
                <a href="/huis/{{ $huis->id }}/beschrijving" class="btn btn-dark">Beschrijving van de woning</a>
              </td>
          </tr>
          @endforeach
      </tbody>
